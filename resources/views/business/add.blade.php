                ...
                <form action="{{route('business.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="add-listing">
                        ...
                        <div class="add-listing-section">
                                    ...
                                    <div class="add-listing-section margin-top-45">
                                        ...
                                        <div class="form">
                                            <h5>Description</h5>
                                            <textarea class="ckeditor WYSIWYG" name="description" cols="40" rows="3" id="summary" spellcheck="true" required></textarea>
                                        </div>
                                    ...
                                    <div class="add-listing-section margin-top-45">
                                        ...
                                        <div class="add-listing-headline">
                                            ...
                                            <!-- Switcher -->
                                            <label class="switch"><input type="checkbox" name="timing_status" checked><span class="slider round"></span></label>
                                        </div>
                                        ...
                                        <div class="switcher-content">
                                            ...
                                            <div class="row opening-day">
                                                <div class="col-md-2"><h5>Monday <input type="hidden" name="day[]" value="Monday"></h5></div>
                                                <div class="col-md-5">
                                            ...
                                            <div class="row opening-day js-demo-hours">
                                                <div class="col-md-2"><h5>Tuesday <input type="hidden" name="day[]" value="Tuesday"></h5></div>
                                                <div class="col-md-5">
                                                    <select class="chosen-select" data-placeholder="Opening Time" name="opening[]">
                                            ...
                                            <!-- Day -->
                                            <div class="row opening-day js-demo-hours">
                                                <div class="col-md-2"><h5>Wednesday <input type="hidden" name="day[]" value="Wednesday"></h5></div>
                                                <div class="col-md-5">
                                                    <select class="chosen-select" data-placeholder="Opening Time" name="opening[]">
                                                        <!-- Hours added via JS (this is only for demo purpose) -->
                                                    </select>
                                            ...
                                            <!-- Day -->
                                            <div class="row opening-day js-demo-hours">
                                                <div class="col-md-2"><h5>Thursday <input type="hidden" name="day[]" value="Thursday"></h5></div>
                                                <div class="col-md-5">
                                                    <select class="chosen-select" data-placeholder="Opening Time" name="opening[]">
                                                        <!-- Hours added via JS (this is only for demo purpose) -->
                                                    </select>
                                            ...
                                            <!-- Day -->
                                            <div class="row opening-day js-demo-hours">
                                                <div class="col-md-2"><h5>Friday <input type="hidden" name="day[]" value="Friday"></h5></div>
                                                <div class="col-md-5">
                                                    <select class="chosen-select" data-placeholder="Opening Time" name="opening[]">
                                                        <!-- Hours added via JS (this is only for demo purpose) -->
                                                    </select>
                                            ...
                                            <!-- Day -->
                                            <div class="row opening-day js-demo-hours">
                                                <div class="col-md-2"><h5>Saturday <input type="hidden" name="day[]" value="Saturday"></h5></div>
                                                <div class="col-md-5">
                                                    <select class="chosen-select" data-placeholder="Opening Time" name="opening[]">
                                                        <!-- Hours added via JS (this is only for demo purpose) -->
                                                    </select>
                                            ...
                                            <!-- Day -->
                                            <div class="row opening-day js-demo-hours">
                                                <div class="col-md-2"><h5>Sunday <input type="hidden" name="day[]" value="Sunday"></h5></div>
                                                <div class="col-md-5">
                                                    <select class="chosen-select" data-placeholder="Opening Time" name="opening[]">
                                                        <!-- Hours added via JS (this is only for demo purpose) -->
                                                    </select>
                    ...
                    @if ($user->status == 1)
                        ...
                        <div class="add-listing-section margin-top-45">
                            ...
                            <div class="add-listing-headline">
                                ...
                                <!-- Switcher -->
                                <label class="switch"><input type="checkbox" name="area_status" @if ($user->status == 1) checked @endif><span class="slider round"></span></label>
                            </div>
					...
					<div class="add-listing-section margin-top-45">
						...
						<div class="add-listing-headline">
							...
							<!-- Switcher -->
							{{-- <label class="switch"><input type="checkbox" name="area_status" checked><span class="slider round"></span></label> --}}
						</div>
